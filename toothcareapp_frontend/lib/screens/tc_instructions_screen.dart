...
class TCInstructionsScreen extends StatefulWidget {
  const TCInstructionsScreen({super.key});
...
class _TCInstructionsScreenState extends State<TCInstructionsScreen> {
  static const List<String> tcDos = [
  ...
  static const List<String> tcDonts = [
  ...
  String _generalChecklistKey(int day) => "tc_dos_day$day";
                    ...
                    child: ElevatedButton.icon(
                      ...
                      onPressed: () {
                        Navigator.of(context).push(
                          MaterialPageRoute(
                            builder: (_) => const TCSpecificInstructionsScreen(),
                          ),
                        );
                      },
                    ),
...
// Specific Instructions screen for Teeth Cleaning
class TCSpecificInstructionsScreen extends StatefulWidget {
  const TCSpecificInstructionsScreen({super.key});

  @override
  State<TCSpecificInstructionsScreen> createState() => _TCSpecificInstructionsScreenState();
}

class _TCSpecificInstructionsScreenState extends State<TCSpecificInstructionsScreen> {
  static const List<String> tcSpecificInstructions = [
  ...
  String _specificChecklistKey(int day) => "tc_specific_day$day";
  ...
  void initState() {
    ...
    if (_checked.length != tcSpecificInstructions.length) {
      _checked = List.filled(tcSpecificInstructions.length, false);
      WidgetsBinding.instance.addPostFrameCallback((_) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          "Specific Instructions (Teeth Cleaning) - Day $currentDay",
