        ...
        children: [
          Row(
            children: [
              Expanded(
                child: Text(
                  "Instructions Followed Log (${_formatDisplayDate(_selectedDateForInstructionsLog)})",
      ...
      child: Column(
        children: [
          ...
          Row(
            ...
            children: [
              Text(
                "$generalCount General followed, $specificCount Specific followed, ${notFollowedGeneralCount + notFollowedSpecificCount} Not followed",
                style: const TextStyle(
                  fontWeight: FontWeight.w600,
                  fontSize: 16,
                  color: Colors.black87,
