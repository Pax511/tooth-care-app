...
class ProfileScreen extends StatelessWidget {
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              ...
                              // Small edit icon button added (doesn't change UI layout otherwise)
                              IconButton(
            ...
            builder: (context, setState) {
              return Column(
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () {
                      // Make sure you have this method in AppState (we added it earlier)
  ...
  static Widget _buildChecklist(List<String> dosList, List<bool> checks) {
    return Card(
      margin: const EdgeInsets.only(bottom: 20),
      elevation: 2,
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16)),
