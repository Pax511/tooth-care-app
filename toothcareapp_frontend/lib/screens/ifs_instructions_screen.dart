...
class _IFSInstructionsScreenState extends State<IFSInstructionsScreen> {
  ...
  static const List<String> dontList = [
    ...
    "Do not smoke/drink alcohol for a week post-surgery.",
  ...
  String _generalChecklistKey(int day) => "ifs_implant_first_dos_day$day";
              ...
              children: [
                ...
                TweenAnimationBuilder<double>(
                  ...
                  child: Container(
                    ...
                    child: const Icon(
                        Icons.emoji_events_rounded, color: Color(0xFF2ECC71),
                        size: 64),
                  ),
                ),
                ...
                SizedBox(
                  ...
                  child: ElevatedButton.icon(
                    icon: const Icon(
                        Icons.assignment_turned_in_rounded, size: 22),
                    ...
                    onPressed: () {
                      Navigator.of(context).pushAndRemoveUntil(
                        MaterialPageRoute(builder: (_) =>
                            TreatmentScreenMain(userName: "User")),
                            (route) => false,
                      );
                    },
                  ),
                              ...
                              child: ElevatedButton.icon(
                                ...
                                onPressed: () {
                                  Navigator.of(context).push(
                                    MaterialPageRoute(
                                      builder: (
                                          _) => const IFSSpecificInstructionsScreen(),
                                    ),
                                  );
                                },
                              ),
...
class IFSSpecificInstructionsScreen extends StatefulWidget {
  const IFSSpecificInstructionsScreen({super.key});

  @override
  State<IFSSpecificInstructionsScreen> createState() =>
      _IFSSpecificInstructionsScreenState();
}

class _IFSSpecificInstructionsScreenState
    extends State<IFSSpecificInstructionsScreen> {
  ...
  String _specificChecklistKey(int day) => "ifs_implant_first_specific_day$day";

  @override
  void initState() {
    super.initState();
    final appState = Provider.of<AppState>(context, listen: false);
    // Try to get the procedure date from AppState, otherwise fallback to today
