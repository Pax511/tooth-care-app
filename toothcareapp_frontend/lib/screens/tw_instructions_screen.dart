...
class TWInstructionsScreen extends StatefulWidget {
  const TWInstructionsScreen({super.key});
...
class _TWInstructionsScreenState extends State<TWInstructionsScreen> {
  static const List<String> twDos = [
  ...
  static const List<String> twDonts = [
  ...
  String _generalChecklistKey(int day) => "tw_dos_day$day";
                    ...
                    child: ElevatedButton.icon(
                      ...
                      onPressed: () {
                        Navigator.of(context).push(
                          MaterialPageRoute(
                            builder: (_) => const TWSpecificInstructionsScreen(),
                          ),
                        );
                      },
                    ),
...
// Specific Instructions screen for Teeth Whitening
class TWSpecificInstructionsScreen extends StatefulWidget {
  const TWSpecificInstructionsScreen({super.key});

  @override
  State<TWSpecificInstructionsScreen> createState() => _TWSpecificInstructionsScreenState();
}

class _TWSpecificInstructionsScreenState extends State<TWSpecificInstructionsScreen> {
  static const List<String> twSpecificInstructions = [
  ...
  String _specificChecklistKey(int day) => "tw_specific_day$day";
  ...
  void initState() {
    ...
    if (_checked.length != twSpecificInstructions.length) {
      _checked = List.filled(twSpecificInstructions.length, false);
      WidgetsBinding.instance.addPostFrameCallback((_) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          "Specific Instructions (Teeth Whitening) - Day $currentDay",
