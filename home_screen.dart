  ...
  Widget _getInstructionsScreen(BuildContext context) {
    ...
    if (treatment == "Implant") {
      if (subtype == "First Stage") {
        return const IFSInstructionsScreen();
      } else if (subtype == "Second Stage") {
        return const ISSInstructionsScreen();
      }
    }
            ...
            ElevatedButton.icon(
              ...
              onPressed: () {
                Navigator.of(context).push(MaterialPageRoute(
                  builder: (_) => const TreatmentScreen(userName: "User"),
                ));
              },
      ...
      child: Column(
        ...
        children: [
          ...
          ListTile(
            ...
            onTap: () {
              Navigator.of(context).push(MaterialPageRoute(
                builder: (context) => const TreatmentScreen(userName: "User"),
              ));
            },
          ),
          ListTile(
