...
class IFSInstructionsScreen extends StatefulWidget {
  const IFSInstructionsScreen({super.key});
...
class _IFSInstructionsScreenState extends State<IFSInstructionsScreen> {
  ...
  void initState() {
    ...
    _dosChecked = List<bool>.from(appState.getChecklistForKey("ifs_implant_first_dos"));
    if (_dosChecked.length != doList.length) {
      _dosChecked = List.filled(doList.length, false);
      appState.setChecklistForKey("ifs_implant_first_dos", _dosChecked);
    }
  }
  ...
  void _updateChecklist(int idx, bool value) {
    ...
    Provider.of<AppState>(context, listen: false)
        .setChecklistForKey("ifs_implant_first_dos", _dosChecked);
  }
                            ...
                            child: ElevatedButton.icon(
                              ...
                              onPressed: () {
                                Navigator.of(context).push(
                                  MaterialPageRoute(
                                    builder: (_) => const IFSSpecificInstructionsScreen(),
                                  ),
                                );
                              },
                            ),
