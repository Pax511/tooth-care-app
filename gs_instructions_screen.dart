...
class _GSInstructionsScreenState extends State<GSInstructionsScreen> {
  ...
  void initState() {
    ...
    _dosChecked = List<bool>.from(appState.getChecklistForKey("gs_dos"));
    if (_dosChecked.length != gsDos.length) {
      _dosChecked = List.filled(gsDos.length, false);
      appState.setChecklistForKey("gs_dos", _dosChecked);
    }
  }
  ...
  void _updateDos(int idx, bool? value) {
    ...
    Provider.of<AppState>(context, listen: false)
        .setChecklistForKey("gs_dos", _dosChecked);
  }
                    ...
                    child: ElevatedButton.icon(
                      ...
                      onPressed: () {
                        Navigator.of(context).push(
                          MaterialPageRoute(
                            builder: (_) => const GSSpecificInstructionsScreen(),
                          ),
                        );
                      },
                    ),
...
class GSSpecificInstructionsScreen extends StatefulWidget {
  ...
  @override
  State<GSSpecificInstructionsScreen> createState() => _GSSpecificInstructionsScreenState();
}

class _GSSpecificInstructionsScreenState extends State<GSSpecificInstructionsScreen> {
  ...
  List<bool> _checked = List.filled(gsSpecificInstructions.length, false);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text(
          "Specific Instructions (Gum Surgery)",
