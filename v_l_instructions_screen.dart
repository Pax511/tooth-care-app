...
class _VLInstructionsScreenState extends State<VLInstructionsScreen> {
  ...
  void initState() {
    ...
    _dosChecked = List<bool>.from(appState.getChecklistForKey("vl_dos"));
    if (_dosChecked.length != vlDos.length) {
      _dosChecked = List.filled(vlDos.length, false);
      appState.setChecklistForKey("vl_dos", _dosChecked);
    }
  }
  ...
  void _updateDos(int idx, bool? value) {
    ...
    Provider.of<AppState>(context, listen: false)
        .setChecklistForKey("vl_dos", _dosChecked);
  }
...
class _VLSpecificInstructionsScreenState extends State<VLSpecificInstructionsScreen> {
  ...
  List<bool> _checked = List.filled(vlSpecificInstructions.length, false);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text(
          "Specific Instructions (Veneers/Laminates)",
